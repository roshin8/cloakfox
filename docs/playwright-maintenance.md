...
This document describes how to maintain Playwright integration in Cloakfox.

## Overview

Cloakfox integrates Playwright's browser automation capabilities through patches and additional files. These need to be kept in sync with upstream Playwright development.
